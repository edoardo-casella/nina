...
const DATAFILES = ["./data/briefing.json", "./data/weather.json", "./data/arrivi.json", "./data/lamma.json",
                   "./data/program.json", "./data/destinations.json", "./data/skipper.json", "./data/crew.json", "./data/trips.json", "./data/anecdotes.json", "./data/diario.json", "./data/riepilogo.json", "./data/mete.json", "./data/proposte.json", "./data/proposte_counts.json"];
